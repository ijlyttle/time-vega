...
Accordingly I would like to see if it is possible to introduce a tz-aware workflow into Vega/Vega-Lite, while keeping the existing workflows intact (Jake's existing chart will still work).
